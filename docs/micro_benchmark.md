...
This page records the current A100 microbenchmark evidence for the MXFP4/INT8
dense and fused MoE paths. The numbers are hardware- and environment-specific
reference points, not portable guarantees.
